  ...
  render() {
    return (
      <div className="blog-post" itemScope itemType="http://schema.org/Article">
        <Helmet>
          <title itemprop="name">Mentoring Hundreds of Progrmaming Students at Lighthouse Labs | Zach Levy's Blog</title>
          <meta name="description" content="I've done thousands of 1-on-1 mentoring sessions with programming students at Lighthouse Labs Web Development Bootcamp." />
          <meta property="og:description" content="I've done hundreds of 1 on 1 mentoring sessions with programming students at Lighthouse Labs Web Development Bootcamp." />
        ...
        <h2 className="blog-post-title">Mentoring Hundreds of Developers at Lighthouse Labs</h2>
        <p className="blog-post-meta"><span itemProp="datePublished" content="2018-03-28">March 28, 2018</span> by <span itemProp="author" itemScope itemType="http://schema.org/Person"><span itemProp="name">Zach Levy</span></span></p>
        <div className="row">
          <div className="col-6 col-sm-4">
            <StatsBlock statistic="2000" description="1-on-1's" />
          </div>
          <div className="col-6 col-sm-4">
            <StatsBlock statistic="4.8" description="Star Rating" />
          </div>
          <div className="col-6 col-sm-4">
            <StatsBlock statistic="32" description="Cohorts" />
          </div>
        </div>
              ...
              <div className="col-12 col-sm-2">
                <div>
                  <a href="http://a.co/jjzqlpf" target="_blank" >
                    <img src={lifeProTipsCoverImg} className="img-fluid" alt="Life Pro Tips: An Addendum To Life. Book Promo" />
                  </a>
                </div>
                <br />
              </div>
