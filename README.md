# zachlevy.me Personal Website
## Development
Start Server with `npm start`

### PsBattles
Steps for publishing a promotional PhotoshopBattle on Reddit.

* Upload image to `public/images/psbattles/`
* Add an object to the file `src/Blog/PhotoshopBattles/battles.js`
* Test by opening local browser. `npm run open` if not already open
